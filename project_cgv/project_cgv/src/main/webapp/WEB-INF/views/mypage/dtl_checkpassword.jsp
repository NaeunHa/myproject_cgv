...
<jsp:include page="../include/header.jsp"></jsp:include>
        ...
        <div class="contents">
        	...
        	<article class="mypage_container">
                ...
                <div class="mypage_content">
                    <h1 class="detail_title">비밀번호 확인</h1>
                    <div id="detail_box3">
                        <h4>고객님의 개인정보 보호를 위한 절차이오니, CGV 로그인 시 사용하는 비밀번호를 입력해 주세요.</h4>
                        <div class="table">
                            <dl>
                                <dt>아이디</dt>
                                <dd><span>${principal.user.userid }</span></dd>
                            </dl>
                            <dl>
                                <dt>비밀번호</dt>
                                <dd><input type="password" class="item_ip"></dd>
                            </dl>
                        </div>
                        <div class="btn_wrap">
                            <button class="submit_btn" onclick="checkPassword()">확인</button>
                        </div>
                    </div>
                </div>
            </article>
    ...
    <script type="text/javascript" src="/js/dtl_checkpassword.js"></script>
</body>
</html>