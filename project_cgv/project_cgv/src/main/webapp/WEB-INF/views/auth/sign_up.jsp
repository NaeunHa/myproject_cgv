            ...
            <div class="su_container">
                ...
                <form action="" class="su_form">
                    ...
                    <dl>
                        ...
                        <dd>
                            <div>
                                <input type="text" id="user_id" class="ip_box" placeholder="아이디를 입력해주세요.">
                    ...
                    <dl>
                        <dt>비밀번호</dt>
                        <dd>
                            <input type="password" id="user_pw" class="ip_box" placeholder="비밀번호를 입력해주세요.">
                    ...
                    <dl>
                        <dt>비밀번호 확인</dt>
                        <dd>
                            <input type="password" id="confirm_pw" class="ip_box" placeholder="비밀번호를 재입력해주세요.">
                    ...
                    <dl>
                        ...
                        <dd>
                            <div>
                                <select id="birth_year"></select>년 
                                <select id="birth_month"></select>월
                                <select id="birth_day"></select>일
                            </div>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div>
                                <input type="text" id="user_email_id"> @ <input type="text">
                                <select id="email_site">
